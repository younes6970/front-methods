...
const Validation = () => {
  return (
    <Div base m={"40px 0 30px"} dir={"column"}>
      <P isP bg={`${colorDark}44`} p={"5px 20px"} m={"0 auto 35px"} radius={RADIUS}>
        {txtValidation.textValidation}
      </P>
      <Div
        w={"100%"}
        m={"10px 0"}
      ...
      >
        ...
        >
          ...
          <Div ltr m={"10px 0 10px"}>
            <Filed item={"username"} />
            <Valid value={".isLength({min:4,max:14}).isEnglish"} />
          </Div>
          <Div ltr m={"10px 0 10px"}>
            <Filed item={"password"} />
            <Valid
              value={".isLength({min:8,max:30}).isEnglish+string(Aa)+number"}
            />
          </Div>
        </Div>
      </Div>
      ...
      >
        ...
        >
          ...
          <Div ltr m={"10px"}>
            <Filed item={"code"} />
            <Valid value={".isNumeric.isLength({min:4,max:4})"} />
          </Div>
          <Div ltr m={"10px"}>
            <Filed item={"age"} />
            <Valid value={".isNumeric.isLength({min:2,max:3})"} />
          </Div>
        </Div>
        <Div
          dir={"column"}
